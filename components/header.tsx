        ...
        <div className="flex items-center gap-6">
          {links.map((link) => (
            <a
              ...
              className="group relative text-sm font-medium text-slate-700 dark:text-slate-200 hover:text-blue-500 dark:hover:text-blue-400 transition-colors duration-200"
            >
              {link.label}
