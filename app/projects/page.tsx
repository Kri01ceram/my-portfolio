  ...
  return (
    <section className="mx-auto max-w-[1100px] px-3 sm:px-5 lg:px-6 py-10 sm:py-12 md:py-14">
      <div className="mb-6 sm:mb-7">
        <h1 className="text-3xl sm:text-4xl font-bold tracking-tight text-slate-900">Projects</h1>
        <p className="mt-1.5 text-slate-600">Choose a domain to explore projects.</p>
      </div>
      <div className="grid gap-5 sm:gap-6 sm:grid-cols-2">
        <Link href="/projects/web">
          <Card className="rounded-2xl group hover:shadow-md transition-shadow">
            ...
            <CardContent>
              <p className="pt-3 text-sm text-slate-700">Valuable, practice, and scaled projects in the web domain.</p>
            </CardContent>
          </Card>
        </Link>
        <Link href="/projects/ml">
          <Card className="rounded-2xl group hover:shadow-md transition-shadow">
            ...
            <CardContent>
              <p className="pt-3 text-sm text-slate-700">Valuable, practice, and scaled projects in the ML domain.</p>
            </CardContent>
          </Card>
        </Link>
      </div>
